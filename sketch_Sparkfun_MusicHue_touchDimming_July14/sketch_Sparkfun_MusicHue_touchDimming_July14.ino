...
CapacitiveSensor   cs_4_20 = CapacitiveSensor(4,20);
...
void loop()
{
  ...
  for (int sensor = 0; sensor < numSensor; sensor++)  
    ...
    readings[7][index] = cs_4_20.capacitiveSensor(30);   // read from the sensor
  ...
  if (count > 10) {
    ...
    Serial.print(tau_filtered[8]);                // print sensor output
    Serial.print('\t');
    Serial.print(tau_filtered[0]);
    Serial.print('\t');
