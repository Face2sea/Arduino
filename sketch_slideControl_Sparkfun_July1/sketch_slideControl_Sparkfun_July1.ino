 ...
 */
/**************************************************************************/
CapacitiveSensor   cs_6_8 = CapacitiveSensor(6,8);        // 10M resistor between pins 0 & 2, pin 2 is sensor pin, add a wire and or foil if desired
CapacitiveSensor   cs_6_10 = CapacitiveSensor(6,10);        // 10M resistor between pins 0 & 2, pin 2 is sensor pin, add a wire and or foil if desired
CapacitiveSensor   cs_6_9 = CapacitiveSensor(6,9);        // 10M resistor between pins 0 & 2, pin 2 is sensor pin, add a wire and or foil if desired
CapacitiveSensor   cs_6_7 = CapacitiveSensor(6,7);        // 10M resistor between pins 0 & 2, pin 2 is sensor pin, add a wire and or foil if desired
...
void loop()
{
  ...
  for (int sensor = 0; sensor < numSensor; sensor++)  
    ...
    readings[0][index] = cs_6_8.capacitiveSensor(30);   // read from the sensor 
    readings[1][index] = cs_6_10.capacitiveSensor(30);   // read from the sensor
    readings[2][index] = cs_6_9.capacitiveSensor(30);   // read from the sensor
    readings[3][index] = cs_6_7.capacitiveSensor(30);   // read from the sensor
  for (int sensor = 0; sensor < numSensor; sensor++) {  
