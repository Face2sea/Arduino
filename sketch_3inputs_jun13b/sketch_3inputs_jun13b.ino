...
CapacitiveSensor   cs_9_3 = CapacitiveSensor(9,3);        // 10M resistor between pins 4 & 6, pin 6 is sensor pin, add a wire and or foil
...
void loop()                    
{
    ...
    long total3 =  cs_9_3.capacitiveSensor(30);
